                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="barcode_number_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('barcode_number', $archive->barcode_number) }}" required
                                        type="number" class="form-control form-control-alternative" id="barcode_number"
                                        name="barcode_number" placeholder="Nomor Barcode" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group" id="condition_id_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="condition_id"
                                        name="condition_id">
                                        <option hidden value="">Pilih Kondisi Berkas</option>
                                        @foreach ($conditions as $condition)
                                            <option
                                                {{ old('condition_id', checkNullData($archive->condition)) == $condition->id ? 'selected' : '' }}
                            ...
                            <div class="form-group" id="rack_location_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('rack_location', $archive->rack_location) }}" required
                                        type="text" class="form-control form-control-alternative" id="rack_location"
                                        name="rack_location" placeholder="Lokasi Rak" autocomplete="off">
                                </div>
                                @error('rack_location')
                                    <span class="invalid-feedback d-inline" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group" id="type_id_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="type_id"
                                        name="type_id">
                                        @foreach ($types as $type)
                                            <option
                                                {{ old('type_id', checkNullData($archive->type)) == $type->id ? 'selected' : '' }}
                            ...
                            <div class="form-group" id="sk_number_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('sk_number', $archive->sk_number) }}" required type="text"
                                        class="form-control form-control-alternative" id="sk_number" name="sk_number"
                                        placeholder="Nomor SK" autocomplete="off">
                                </div>
                                @error('sk_number')
                                    <span class="invalid-feedback d-inline" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group" id="name_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('name', $archive->name) }}" required type="text"
                            ...
                            <div class="form-group" id="address_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('address', $archive->address) }}" required type="text"
                                        class="form-control form-control-alternative" id="address" name="address"
                            ...
                            <div class="form-group" id="provinsi_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="provinsi"
                                        name="provinsi">
                            ...
                            <div class="form-group" id="kab_kota_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="kab_kota"
                                        name="kab_kota">
                                    </select>
                                </div>
                                @error('kab_kota')
                            ...
                            <div class="form-group" id="kecamatan_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="kecamatan"
                                        name="kecamatan">
                                    </select>
                                </div>
                                @error('kecamatan')
                            ...
                            <div class="form-group" id="kelurahan_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="kelurahan"
                                        name="kelurahan">
                                    </select>
                                </div>
                                @error('kelurahan')
                            ...
                            <div class="form-group" id="right_type_id_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2" id="right_type_id"
                                        name="right_type_id">
                                        <option hidden value="">Pilih Jenis Hak</option>
                                        @foreach ($rights as $right)
                                            <option
                                                {{ old('right_type_id', checkNullData($archive->rightType)) == $right->id ? 'selected' : '' }}
                                                value="{{ $right->id }}">{{ $right->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('right_type_id')
                            ...
                            <div class="form-group" id="scan_status_id_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2"
                                        id="scan_status_id" name="scan_status_id">
                                        <option hidden value="">Pilih Status Pindai</option>
                                        @foreach ($scans as $scan)
                                            <option
                                                {{ old('scan_status_id', checkNullData($archive->scanStatus)) == $scan->id ? 'selected' : '' }}
                                                value="{{ $scan->id }}">{{ $scan->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group" id="physical_status_id_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <select required class="form-control form-control-alternative mr-2"
                                        id="physical_status_id" name="physical_status_id">
                                        <option hidden value="">Pilih Status Fisik</option>
                                        @foreach ($physicals as $physical)
                                            <option
                                                {{ old('physical_status_id', checkNullData($archive->physicalStatus)) == $physical->id ? 'selected' : '' }}
                                                value="{{ $physical->id }}">{{ $physical->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group" id="description_form">
                                ...
                                <div class="input-group input-group-alternative">
                                    <input value="{{ old('description', $archive->description) }}" type="text"
                                        class="form-control form-control-alternative" id="description" name="description"
                                        placeholder="Keterangan Berkas" autocomplete="off">
                                </div>
                                @error('description')
                                    <span class="invalid-feedback d-inline" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            success: function(data) {
                                if (data) {
                                    ...
                                    $.each(data, function(key, item) {
                                        $('#kab_kota').append('<option value="' + item.id +
                                            '">' + item.name + '</option>');
                                    });

                                    if ("{{ $archive->provinsi }}") {
                                        if (first) {
                                            $("#kab_kota option:contains('{{ $archive->kab_kota }}')")
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data) {
                                    ...
                                    if ("{{ $archive->provinsi }}") {
                                        if (first) {
                                            $("#kecamatan option:contains('{{ $archive->kecamatan }}')")
                                                .prop("selected", "selected").change();
                                        }
                                    }
                                } else {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data) {
                                    $('#kelurahan').empty();
                                    $('#kelurahan').append(
                                        '<option hidden value="">Pilih Kelurahan</option>');
                                    $.each(data, function(key, item) {
                                        $('#kelurahan').append('<option value="' + item.id +
                                            '">' + item.name + '</option>');
                                    });

                                    if ("{{ $archive->provinsi }}") {
                                        if (first) {
                                            $("#kelurahan option:contains('{{ $archive->kelurahan }}')")
                                                .prop("selected", "selected").change();
                                        }
                                    }
                                } else {
