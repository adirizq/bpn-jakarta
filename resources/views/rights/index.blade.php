    ...
    <div class="container-fluid mt--7 pt-5 pt-md-0">
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Archive Right Types</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="" class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#addModal">Add right type</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="{{ route('rightType.store') }}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-alternative">
                                ...
                                <input type="text" class="form-control form-control-alternative" id="name" name="name" placeholder="Right Type Name">
                            </div>
                            @error('name')
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Add Right Type</button>
                    </div>
                </form>
            </div>
            </div>
                ...
                <div class="modal-content bg-gradient-danger">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="py-3 text-center">
                            ...
                            <p>Are you sure want to delete this right type? <br> Every deleted right type can't be restored!</p>
                        </div>
                    ...
                    <div class="modal-footer">
                        <form method="post" id="form_delete"
                            ...
                            @method('delete')
                            @csrf
                            <button type="submit" class="btn btn-white">Delete Right Type</button>
                        </form>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input type="text" class="form-control form-control-alternative" id="new_name" name="new_name" placeholder="New Right Type Name">
                                </div>
                                @error('new_name')
                                    <span class="invalid-feedback d-inline" role="alert">
                                        <strong>{{ $message }}</strong>
...
@push('js')
    ...
    <script>
        $('#changeNameModal').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-header .modal-title').html('Change right type ' + name + ' name')
            modal.find('.modal-content #form_update').attr('action', baseUrl + '/rightType/' + id)
        })
        ...
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body .heading').html('Delete right type ' + name + ' ?')
            modal.find('.modal-footer #form_delete').attr('action', baseUrl + '/rightType/' + id);
        })
    </script>
@endpush
